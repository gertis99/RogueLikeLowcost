...
public class RandomState : State
{
    ...
    public RandomState(Enemy2SM stateMachine) : base("Random", stateMachine)
    {
    ...
    public override void Logic()
    {
        ...
        {
            // If the player is near, change to scared state
            if (distance < 3.0f)
            {
                stateMachine.ChangeState(enemy2SM.scaredState);
            }
            else
            {
